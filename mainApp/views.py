...
def home(Request):
    data = Product.objects.all().order_by('id').reverse()[:7]
...
def signupPage(Request):
    if (Request.method == "POST"):
        ...
        if (p == cp):
            ...
            messages.error(
                Request, "Password And Conform Password Doesn't Matched!!!!!")
...
def orderPage(Request):
    if(Request.method=="POST"):
        ...
        if(cart is None):
            ...
            message = "Thanks to Shop With Us\nYou has been placed\nNow You Can Track Your Orders in Profile Page: Team Eshop"
            email_from = settings.EMAIL_HOST_USER
...
def contactPage(Request):
    if(Request.method=="POST"):
        ...
        c.save()
        messages.success(Request,"Thanks to Share Your Query Will US!! Our Team Will Contact You Soon!!!")
    ...
    if(Request.method=="POST"):
        ...
        if(username):
            if(password==cpassword):
                ...
                messages.error(Request,"Password andconform Password Doesn't Matched !!!!!")
        else:
            messages.error(Request,"UnAuthorized !!!!!")
